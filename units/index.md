...
Navigate to any section of the course.

---

## Unit 1: Systems of Linear Equations

*The row picture: equations as geometric constraints.*

| Section | Topic |
|---------|-------|
| [1.1](../articles/unit1/1.1-introduction-to-linear-systems.html) | Introduction to Linear Systems |
| [1.2](../articles/unit1/1.2-augmented-matrices-and-row-reduction.html) | Augmented Matrices and Row Reduction |
...
*The column picture: building vectors from other vectors.*

| Section | Topic |
|---------|-------|
| [2.1](../articles/unit2/2.1-vectors-in-rn.html) | Vectors in ℝⁿ |
...
*The transformation picture: matrices as functions.*
...
- **Unit 9:** Least Squares
- **Unit 10:** Symmetric Matrices
- **Unit 11:** Singular Value Decomposition
