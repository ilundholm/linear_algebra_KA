...
_A draggable arrow starting at the origin. As user moves the tip, the coordinates update._
...
**[PLACEHOLDER: Interactive widget]**
_Two draggable vectors. Their sum is shown as a third vector. User can toggle between tip-to-tail and parallelogram visualizations._

---

**Practice Problem:** Compute $\begin{bmatrix} 2 \\ -1 \\ 3 \end{bmatrix} + \begin{bmatrix} -1 \\ 4 \\ 2 \end{bmatrix}$.
...
**Practice Problem:** What is $-2 \cdot \begin{bmatrix} 3 \\ -4 \end{bmatrix}$?

- (A) $\begin{bmatrix} -6 \\ -8 \end{bmatrix}$
- (B) $\begin{bmatrix} -6 \\ 8 \end{bmatrix}$
- (C) $\begin{bmatrix} 6 \\ 8 \end{bmatrix}$
...
[← Previous: Applications](../unit1/1.4-applications.md) | [Back to Home](/) | [Next: Linear Combinations and Span →](2.2-linear-combinations-and-span.md)
