...
![Dependent (parallel) vs Independent (non-parallel) vectors](/linear_algebra_KA/images/dependent_vs_independent.png)
...
<video src="/linear_algebra_KA/videos/CoplanarVsNonCoplanar.mp4" autoplay loop muted playsinline style="max-width:100%; border-radius:8px;"></video>
...
<iframe src="https://ilundholm.github.io/linear_algebra_KA/widgets/linear-dependence.html" width="100%" height="800" style="border: none; border-radius: 8px;"></iframe>
...
[← Previous: Linear Combinations and Span](2.2-linear-combinations-and-span.md) | [Back to Home](https://ilundholm.github.io/linear_algebra_KA/) | [Next: Matrix-Vector Multiplication →](../unit3/3.1-matrix-vector-multiplication.md)
